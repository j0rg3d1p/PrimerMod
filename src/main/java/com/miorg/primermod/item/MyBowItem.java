...
public class MyBowItem extends ProjectileWeaponItem implements Vanishable {
    public static final int MAX_DRAW_DURATION = 20;
    public static final int DEFAULT_RANGE = 150;

    public MyBowItem(Item.Properties p_40660_) {
        super(p_40660_);
    }
               ...
               // if (itemstack.isEmpty()) {
                ...
                if (!((double)f < 0.1D)) {
                    ...
                    if (!p_40668_.isClientSide) {
                        ...
                        //if (j > 0) {
                            abstractarrow.setBaseDamage(abstractarrow.getBaseDamage() + (double)j * 6.5D + 6.5D);
                        //}
